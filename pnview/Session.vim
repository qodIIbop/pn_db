...
silent only
cd /net/hdlan02./c/proj/ddr/pnview
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +24 index.php
badd +0 Pagination.php
badd +0 reset.css
badd +0 style.css
badd +0 typography.css
args index.php Pagination.php reset.css style.css typography.css
set lines=59 columns=164
edit index.php
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((11 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
